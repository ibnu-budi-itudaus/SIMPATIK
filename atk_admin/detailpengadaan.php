  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12 mt-3">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Detail Pengadaan</h5>
              <div class="container">
              	<div class="row">
              		<div class="col-sm-12 col-md-12 mt-2">
              			<h5 class="card-text text-center"><hr>Daftar Terima Barang</h5>
              			<br>
        ...
        <tr>
          ...
          <th>Rp. <?php echo number_format($total) ?></th>
				...
				<br>	
				<hr>	
				<a class="btn btn-sm btn-info mt-2" href="pengadaan.php"><i class="fas fa-arrow-left"></i> Kembali</a>	
